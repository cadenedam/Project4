...
public class MarketServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            BufferedReader socketReader = new BufferedReader(new InputStreamReader(newSocket.getInputStream()));
            PrintWriter socketWriter = new PrintWriter(newSocket.getOutputStream(), true);
                        ...
                        do {
                            ...
                            if (userNum == 1) {
                                ...
                                do {
                                    ...
                                    String password = socketReader.readLine();
